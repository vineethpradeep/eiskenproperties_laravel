...
<body class="body" style="background-color: #E1E1E1; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
        ...
        <tbody>
            <tr>
                <td>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div class="alignment" align="center">
                                                                    <div style="max-width: 275px;"><img src="https://res.cloudinary.com/eiskenproperties/image/upload/v1748298061/b8vkrjlbysp1gdkvtv6m.png" style="display: block; height: auto; border: 0; width: 100%;" width="275" alt="Image" title="Image" height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #edac15;">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table class="image_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                                                            <td class="pad" style="padding-top:15px;width:100%;">
                                                                <div class="alignment" align="center">
                                                                    <div style="max-width: 500px;"><img src="https://res.cloudinary.com/eiskenproperties/image/upload/v1748297839/rvtjzpgfjqgp0owifrub.png" style="display: block; height: auto; border: 0; width: 100%;" width="500" alt="Image" title="Image" height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top;">
                                                    ...
                                                    <table class="paragraph_block block-8" width="100%" border="0" cellpadding="20" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#555555;font-family:Georgia, Times, 'Times New Roman', serif;font-size:12px;line-height:1.2;text-align:center;mso-line-height-alt:14px;">
                                                                    <p style="margin: 0; word-break: break-word;">Copyright @ Eisken Properties Need help? <a href="mailto:enquiries@eiskenp.com?subject=Enquiry" target="_blank" title="enquiries@eiskenp.com" style="text-decoration: none; color: #555555;" rel="noopener">Contact Us</a></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
