    ...
    <div class="container">
        <ul class="nav nav-tabs mb-3" id="searchTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="sale-tab" data-bs-toggle="tab" data-bs-target="#sale-form" type="button" role="tab" aria-controls="sale-form" aria-selected="true">
                    For Sale
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="rent-tab" data-bs-toggle="tab" data-bs-target="#rent-form" type="button" role="tab" aria-controls="rent-form" aria-selected="false">
                    For Rent
                </button>
            </li>
        </ul>
        ...
        <div class="tab-content" id="searchTabContent">
            <!-- Sale Form -->
            <div class="tab-pane fade show active" id="sale-form" role="tabpanel" aria-labelledby="sale-tab">
